...
const CustomerListing = ({
  ...
  if (isLoading)
    return (
      <div className="md:max-w-4xl max-w-2xl mx-auto p-6 mt-36 bg-white rounded-md border shadow-md">
        <Skeleton />
      </div>
    );
  if (isError)
  ...
  return (
    <div className="  lg:max-w-5xl mx-auto p-5 mt-24  lg:ml-[300px]  sm:mt-14 md:mt-14 border mr-[11px] ml-[11px] rounded-md shadow-md">
      ...
      <div className="overflow-x-auto max-h-[350px]">
        <table className="min-w-full bg-whie table-auto">
          <thead className="bg-gray-100 text-2xl sticky top-0 text-center">
            <tr>
              <th className="px-4 py-2 border-b-2 border-gray-300 text-left font-semibold text-gray-700">
                Name
              </th>
              <th className="px-4 py-2 border-b-2 border-gray-300 text-left font-semibold text-gray-700">
                Email
          ...
          <tbody>
            {data?.data
              ...
              .map((customer:any) => (
                <tr
                  key={customer._id}
                  className="hover:bg-gray-50 text-xl transition-all"
                >
