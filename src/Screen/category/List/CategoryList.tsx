    ...
    <div className="max-w-[330px] lg:max-m-full mt-24 p-4  lg:max-w-4xl  lg:mt-10 mx-auto  sm:p-6 md:p-8 :mt-12 border bg-white rounded-md shadow-md">
      ...
      <div className="overflow-auto max-w-full max-h-[430px]">
        <table className="w-full bg-white">
          <thead className="bg-gray-100 sticky top-0 text-base sm:text-lg md:text-xl lg:text-xl text-center">
            <tr>
              <th className="px-2 sm:px-4 py-2 border-b-2 border-gray-300 font-semibold text-gray-700">Category Name</th>
              <th className="px-2 sm:px-4 py-2 border-b-2 border-gray-300 font-semibold text-gray-700 text-center">Actions</th>
            </tr>
          </thead>
          <tbody>
            {data?.data?.slice().reverse().map((category) => (
              <tr key={category._id} className="hover:bg-gray-50 transition duration-200 text-center">
                ...
                <td className="px-2 sm:px-4 py-3 text-sm sm:text-lg md:text-xl lg:text-2xl text-center">
                  <button
