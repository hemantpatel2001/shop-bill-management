...
export const PageRoute = () => {
  const router = createBrowserRouter([
    ...
    { path: "/", element: <Auth><LoginWrapper /></Auth> },
    {
      path: "/shop-bill-management", element: <Auth><Layout /></Auth>,
      children: [
        { path: "add-customer", element: <AddCustomerFormWrapper /> },
        { path: "customer-details", element: <CustomerListingWrapper /> },
        { path: "edit-customer", element: <EditCustomerFormWrapper /> },
        { path: 'customer-details/edit-customer/:id', element: <EditCustomerFormWrapper /> },
        { path: "add-category", element: <AddCategoryWrapper /> },
        { path: "edit-category", element: <EditCategoryWrapper /> },
        { path: "category-details", element: <CategoryListWrapper /> },
        { path: '/shop-bill-management/edit-category/:id', element: <EditCategoryWrapper /> },
        { path: "add-Product", element: <AddProductWrapper /> },
        { path: "edit-product", element: <EditProductWrapper /> },
        { path: '/shop-bill-management/edit-product/:id', element: <EditProductWrapper /> },
        ...
        { path: '/shop-bill-management/edit-vendore/:id', element: <EditVendorsFormWrapper /> },
